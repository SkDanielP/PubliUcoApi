package co.edu.uco.publiuco.api.validator.estadotipoescritor;
...
public final class RegistrarEstadoTipoEscritorValidation implements Validation<EstadoTipoEscritorDTO> {

	private RegistrarEstadoTipoEscritorValidation() {
		super();
	}
	
	public static final Result validate(final EstadoTipoEscritorDTO data){
		return new RegistrarEstadoTipoEscritorValidation().execute(data);
	}
	
	@Override
	public Result execute(final EstadoTipoEscritorDTO data) {
