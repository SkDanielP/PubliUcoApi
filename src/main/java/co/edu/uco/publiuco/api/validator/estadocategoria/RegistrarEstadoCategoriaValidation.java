package co.edu.uco.publiuco.api.validator.estadocategoria;
...
public final class RegistrarEstadoCategoriaValidation implements Validation<EstadoCategoriaDTO> {

	private RegistrarEstadoCategoriaValidation() {
		super();
	}
	
	public static final Result validate(final EstadoCategoriaDTO data){
		return new RegistrarEstadoCategoriaValidation().execute(data);
	}
	
	@Override
	public Result execute(final EstadoCategoriaDTO data) {
